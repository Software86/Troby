CREATE DATABASE  IF NOT EXISTS `troby` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `troby`;
...
CREATE TABLE `achievements` (
  ...
  `worth` enum('bronze','silver','gold','platinum') DEFAULT NULL,
  `score` int(4) NOT NULL,
  `info` tinytext,
  `game_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `achievements_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2019-03-25 20:05:08
